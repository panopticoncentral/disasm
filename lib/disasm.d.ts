...
export declare class LayoutError implements Error {
...
export declare enum OperandInfoFlags {
    None = 0,
    Branch = 1,
    Unconditional = 2,
}
export declare class OperandInfo {
    private _name;
    private _flags;
...
export declare var operandInfo: OperandInfo[];
...
export declare class RegisterOperand extends Operand {
...
export declare class SegmentOperand extends Operand {
...
export declare class ImmediateOperand extends Operand {
    private _value;
    private _size;
...
export declare class CallOperand extends Operand {
...
export declare class AdditionOperand extends Operand {
    private _left;
    private _right;
...
export declare class IndirectOperand extends Operand {
    private _operand;
    private _size;
    private _segment;
...
export declare class RepeatOperand extends Operand {
    private _operand;
    private _negate;
...
export declare class ScaleOperand extends Operand {
    private _index;
    private _scale;
...
export declare class FloatingPointStackOperand extends Operand {
    private _index;
...
export declare class Instruction {
    ...
    private _operand2;
    private _operand3;
    constructor(opCode: OpCode, isLocked: boolean, isNear: boolean, repeatType: RepeatType, operand1?: Operand, operand2?: Operand, operand3?: Operand);
